...
var MemoStorage = /** @class */ (function () {
    ...
    MemoStorage.prototype.getSession = function (flag, func) {
        ...
        var sequenceIds = __assign({}, session === null || session === void 0 ? void 0 : session.sequenceIds);
        var sequenceId = isNaN(sequenceIds[flag]) ? 0 : sequenceIds[flag];
        session =
        ...
        this.storage.set(MemoStorage.SESSION_STORAGE_KEY, {
            sessionId: session.sessionId,
            timestamp: session.timestamp,
            sequenceIds: session.sequenceIds,
        });
    ...
    IndexedDBStorage.prototype.getSession = function (flag, fn) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            new Promise(function (resolve, reject) {
                ...
                sessionReq.onsuccess = function () { return resolve(sessionReq.result); };
                sessionReq.onerror = function () { return reject(); };
                ...
                if (!rawSession) {
                    ...
                    sequenceIds = __assign({}, rawSession.sequenceIds);
                    var sequenceId = isNaN(sequenceIds[flag]) ? 0 : sequenceIds[flag];
                    session = fn(__assign(__assign({}, rawSession), { sequenceIds: sequenceIds, sequenceId: sequenceId }));
                }
                store.put({
                    sessionId: session.sessionId,
                    timestamp: session.timestamp,
                    sequenceIds: __assign(__assign({}, sequenceIds), (_a = {}, _a[flag] = session.sequenceId, _a)),
                }, IndexedDBStorage.KEY_SESSION);
            });
        });
    };
...
var SessionManager = /** @class */ (function () {
    ...
    SessionManager.prototype.getSession = function (_a) {
        var flag = _a.flag, _b = _a.reset, reset = _b === void 0 ? false : _b, lastSessionId = _a.lastSessionId;
        return __awaiter(this, void 0, void 0, function () {
            var trackingStorage;
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, trackingStorage.getSession(flag, function (session) {
                                ...
                                else if (lastSessionId && lastSessionId !== session.sessionId) {
                                    session.sequenceId = 0;
    ...
    SessionManager.prototype.GetSessionId = function (_a) {
        var flag = _a.flag, _b = _a.reset, reset = _b === void 0 ? false : _b, lastSessionId = _a.lastSessionId;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.getSession({ flag: flag, reset: reset, lastSessionId: lastSessionId })];
                    case 2:
                        session = _c.sent();
